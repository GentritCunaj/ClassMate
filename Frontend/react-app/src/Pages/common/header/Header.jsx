      ...
      <header>
        <nav style={style} className='flexSB'>
          <ul className={click ? "mobile-nav" : "flexSB "} onClick={() => setClick(false)}>
            ...
            <li style={{ left: 0, position: "relative" }} id="dropdownLi" className="nav-item dropdown dropdown-hover position-static">
                    ...
                    {subjects != null && subjects.map((subject) => (
                      <div className="col-md-6 col-lg-4 mb-3 mb-lg-0" key={subject.subjectId}>
                        <div className="list-group list-group-flush">
                          <Link to={`/subject/${subject.subjectId}`} id="subjectBackground" className="list-group-item list-group-item-action">
                            <h5>{subject.name}</h5>
                          </Link>
                        </div>
                      </div>
